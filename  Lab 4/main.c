...
void main(void)
{
    ...
    while(1)
    {
        ...
        case 0:
            ...
            masterSpiWrite(w);
            //read function is breaking the program
            r = slaveSpiRead();
            out[0] = ' ';
            out[1] = r;
            out[2] = ' ';
            Graphics_drawStringCentered(&g_sContext, volArray, 4, 50, 25, TRANSPARENT_TEXT);
            Graphics_drawStringCentered(&g_sContext, out, AUTO_STRING_LENGTH, 50, 50, TRANSPARENT_TEXT);
