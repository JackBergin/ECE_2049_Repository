...

{
    ...
    unsigned char your_name[11] = "Jack Bergin";
    ...
    Graphics_drawStringCentered(&g_sContext, "Welcome", AUTO_STRING_LENGTH, 25, 40, TRANSPARENT_TEXT);
    Graphics_drawStringCentered(&g_sContext, "to", AUTO_STRING_LENGTH, 10, 50, TRANSPARENT_TEXT);
    Graphics_drawStringCentered(&g_sContext, "ECE2049-C21!", AUTO_STRING_LENGTH, 40, 60, TRANSPARENT_TEXT);
    Graphics_drawStringCentered(&g_sContext, your_name, AUTO_STRING_LENGTH, 35, 70, TRANSPARENT_TEXT);

    //Number display:
    Graphics_drawStringCentered(&g_sContext, "Keypad: ", AUTO_STRING_LENGTH, 30, 90, OPAQUE_TEXT);

    /* I didnt really like the box
    ...
    */
    ...
    while (1)    // Forever loop
    {
        ...
        if (currKey)
        {
            ...
            Graphics_drawStringCentered(&g_sContext, dispThree, dispSz, 55, 90, OPAQUE_TEXT);
